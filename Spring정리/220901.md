...
- DispatcherServlet
  ...
  - 디스패처서블릿의 동작과정 도식화
    ![dispatcher](./Spring정리/img/dispatcher.png)
...
- context?
  ...
  <details><summary style="color:skyblue">web.xml</summary>
	<p>
```html
<context-param>
	<param-name>contextConfigLocation</param-name>
...
### ioc컨테이너에 관리대상으로 등록하는 방법 : 1.xml에 bean으로 전부 다 등록하기 2.java annotation 사용하기(xml은 부가적인느낌)
...
![springmvc](./Spring정리/img/springmvc.png)
