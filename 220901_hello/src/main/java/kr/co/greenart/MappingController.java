...
public class MappingController {
	...
	public @ResponseBody String doURI() {
		//resp.setContentType("text/pain; charset=utf-8"); <- 이거 안먹힘~!
		return "do로 끝나는 매핑";
	}
	...
	@GetMapping(value = "/qqq", params = "com") //com파라미터가 있고
	public @ResponseBody String qqq(@RequestParam(defaultValue = "default") String com) { //값이 없으면 디폴트값으로ㄱ
		return com;
	}
}
